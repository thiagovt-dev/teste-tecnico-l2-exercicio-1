...
export class PackagingController {
  ...
  @Post()
  @ApiOperation({
    summary: 'Calcula a melhor forma de empacotar pedidos',
    description:
      'Recebe uma lista de pedidos com produtos e suas dimensões, e retorna a distribuição otimizada desses produtos em caixas.',
  })
  @ApiResponse({
    status: 201,
